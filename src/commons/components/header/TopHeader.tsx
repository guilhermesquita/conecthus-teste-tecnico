            ...
            >
                <div className="relative">
                    <div className={`w-12 h-12 rounded-full bg-main-green-300 flex items-center justify-center text-white ring-3 transition-all duration-300 ${isHovered ? 'ring-main-hover' : 'ring-main-cyan-100'}`}>
                        <span className="text-lg font-bold tracking-tight">MS</span>
                    </div>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-[6px]">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <h4 className="text-main-cyan-200 font-bold text-lg truncate leading-tight">Milena Santana Borges</h4>
                                    <p className="text-main-green-300/80 text-sm truncate font-medium">milena.santana@energy.org.br</p>
                                </div>
                            </div>

                            <button className="w-full text-left mt-3 py-[7px] px-[6px] flex items-center gap-[6px] hover:bg-main-cyan-200/18 rounded transition-all group active:scale-95 cursor-pointer text-main-green-300">
